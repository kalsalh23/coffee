  ...
  return (
    ...
    >
      <div className="relative aspect-square rounded-2xl bg-gradient-to-br from-olive-100 via-olive-50 to-olive-200 flex items-center justify-center overflow-hidden">
        <span className="text-6xl drop-shadow-sm transition-transform group-hover:scale-110 duration-200">
          {product.emoji}
        </span>
        {product.is_featured && (
          <span className="absolute top-2 start-2 inline-flex items-center gap-1 bg-olive-700 text-olive-50 text-[10px] font-bold px-2 py-0.5 rounded-full">
